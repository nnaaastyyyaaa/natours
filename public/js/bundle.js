...
var displayMap = exports.displayMap = function displayMap(locations) {
  var map = new maplibregl.Map({
    container: 'map',
    // container id
    style: 'https://api.maptiler.com/maps/streets-v2-light/style.json?key=e3io1UZsfD3yeUIqZe9E',
    // style URL
    scrollZoom: false
  });
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; } /* eslint-disable */
var stripe = Stripe('pk_test_51RcuHTC8th56ZY1qZuD8TbjBiDjUqxbFhadmqrho1YjRYcJ7DYxp4VsmciUnaEg1rHrUQmXuVlorBZdtpw4JxYLq00X4bnD2TQ');
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return (0, _axios.default)("http://127.0.0.1:3000/api/v1/bookings/checkout-session/".concat(id));
        case 3:
...
var logF = document.querySelector('.form--login');
var logoB = document.querySelector('.nav__el--logout');
var usDataForm = document.querySelector('.form-user-data');
var usPassForm = document.querySelector('.form-user-settings');
var bookBtn = document.getElementById('book-tour');
if (logoB) logoB.addEventListener('click', _login.logout);
if (mapBox) {
...
if (usDataForm) {
  usDataForm.addEventListener('submit', function (e) {
    e.preventDefault();
...
if (usPassForm) {
  usPassForm.addEventListener('submit', /*#__PURE__*/function () {
